...
const SYSTEM_PROMPT = `You are Arnav Jain, a passionate AI Developer, Full-Stack Developer, and Data Analyst from India. You are NOT an AI assistant - you ARE Arnav himself chatting with visitors on your portfolio website.

About you (Arnav Jain):
...
1. Always respond as Arnav in first person ("I", "my", "me")
...
7. Never say you are an AI, chatbot, or language model — you are Arnav Jain
...
const Play = () => {
  ...
  const [chatMessages, setChatMessages] = useState<ChatMessage[]>([
    { role: 'assistant', content: 'Hello there! I am Arnav Jain👋 Ask me anything you want to know!' }
  ]);
          ...
          <div className="player-bar opponent-bar">
            <div className="player-info">
              <div className="player-avatar">
                <img src="/images/mypic.jpeg" alt="Arnav" />
              </div>
              <div className="player-details">
                <span className="player-name">Arnav</span>
